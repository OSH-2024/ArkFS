import queue
import file_operation.string_storage as string_storage
import os
import numpy as np
from file_operation.file_add import my_add
from file_operation.file_delete import my_delete
from file_operation.file_search import my_search

# index = "D:\\arkfs\\LabelMatching\\target_folder"
# index = os.getcwd()
index = "E:\\Codefield\\CODE_C\\Git\\ArkFS\\test_directory"
